...
using GamePlanner.Valheim.Mining;
using HarmonyLib;
using UnityEngine;
...
{
    /// <summary>
    /// Minerador do Valheim para o Game Planner. Dentro de um mundo, a tecla (F7 por padrão) abre o painel
    /// da conta; "Minerar e enviar" lê os dados do jogo na thread principal e envia numa thread de fundo.
    ///
    ...
    public class GamePlannerValheim : BaseUnityPlugin
    {
        public const string PluginGuid = "paradoxbh.gameplanner.valheim";
        ...
        private void Awake()
        {
            ...
            _includeImages = Config.Bind("Mineração", "IncludeImages", true, "Extrai e envia os ícones.");
            _maxImageSize = Config.Bind("Mineração", "MaxImageSize", 256,
                new ConfigDescription("Maior lado dos ícones extraídos, em pixels.", new AcceptableValueRange<int>(32, 1024)));
            ...
            _panel = new AccountPanel("Game Planner — Valheim", form, _progress);
