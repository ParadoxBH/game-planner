...
import { ShopItemCard, type ShopItem, type ShopCondition } from "./shops/ShopItemCard";
...
export function ShopsPage() {
  ...
  if (!shops || shops.length === 0) {
    return (
      <StyledContainer title={`Lojas de ${gameId}`} label="Visite os NPCs locais para comprar suprimentos e trocar recursos.">
            ...
            <Stack spacing={3}>
              <Card sx={{ 
                ...
                <Box sx={{ 
                  ...
                  background: 'linear-gradient(135deg, rgba(255, 68, 0, 0.05), rgba(255, 136, 0, 0.05))'
                }}>
                  {currentNpc?.icon ? (
